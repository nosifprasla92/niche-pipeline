        ...
        <div className="flex flex-col items-start sm:items-end gap-1">
          <div className="flex items-center gap-1.5 sm:gap-3 flex-wrap">
            ...
            <button
              ...
              className="px-3 py-2.5 sm:py-2 text-sm rounded-md border border-border text-muted hover:text-text hover:bg-border/60 disabled:opacity-50"
            >
            ...
            <button
              onClick={runNow}
              disabled={running}
              className="px-3 py-2.5 sm:py-2 text-sm rounded-md border border-border text-text hover:bg-border/60 disabled:opacity-50"
            >
